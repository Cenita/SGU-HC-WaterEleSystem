  ...
  <div class="mainPart">
    <div class="checkPart">
      ...
      <div class="buildingPart">
        ...
        <select class="ui dropdown" v-model="buildingId"  id="buildingId">
    ...
    <div style="display:none"  v-show="partSeen" class="getPart">
      ...
      <div class="ui raised segment" v-show="sendPost" id="inPart" >
        <h4 class="ui horizontal divider header">电水费</h4>
        <div id="getBasicInformation">
          <div class="getWaterPart topInformation">
            <span class="title">水费：</span>
            <span class="content">{{ waterRecord }}元</span>
          </div>
          <div class="getElePart topInformation">
            <span class="title">电费：</span>
            <span class="content">{{ eleRecord }}元</span>
          </div>
        </div>
        <h4 class="ui horizontal divider header">水费统计表</h4>
        <div id="sixDayWaterPart">
          ...
          <div class="ui middle aligned list weList">
            <div class="item">
              <div>具体余额</div>
              <div>日期</div>
            </div>
        ...
        <h4 class="ui horizontal divider header">电费统计表</h4>
        ...
        <h4 class="ui horizontal divider header">充值记录表</h4>
        <div id="TopUpPart">
